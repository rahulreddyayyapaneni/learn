...
def enter_move(board):
    ...
    if len(O_moves) == len(X_moves):
        ...
        print("Machine already choose "+ str(X_moves[-1])+" It's you turn now!")
        # print((len(X_moves))-1)
    # print(cur_stat)
    ...
    if (O_Result or X_Result) != True:
        ...
        if x.isdigit()!= True:
            ...
            print("Invalid move, Please enter a numeric")
            return

        else:
            # print("Pass")
            e = int(x)
            if e in (X_moves or O_moves) and e <= 9:

                print(str(e) +" was taken,Please choose a free move in the board")
                enter_move(board)
            else:
                # continue
        ...
        # else:
        #     print("It's already taken,Please choose a free move")
    else:
